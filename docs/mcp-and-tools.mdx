...
By default, both local and MCP tool calls pause for human approval before they
run. See [Human-in-the-Loop Approvals](/docs/human-in-the-loop) to configure
approval behavior and auto mode.
